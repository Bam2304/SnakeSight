...
def create_sighting(db: Session, *, user_id: str, payload: SightingCreate):
...
def list_my_sightings(db: Session, *, user_id: str, since_days: int = 365):
...
def last_known_by_point(db: Session, *, lat, lon, radius_km, since_days, venom_only):
